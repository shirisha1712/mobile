...
export const FrameSubsection = (): JSX.Element => {
  return (
    <Card className="flex flex-col w-full max-w-[383px] h-[318px] items-start gap-4 pt-0 pb-[17.46px] px-0 bg-neutralgrey-10 rounded-[15px_15px_16.54px_16.54px] shadow-[0px_4.76px_4.76px_#0000004c] overflow-hidden">
      ...
      <CardContent className="h-[90.21px] relative w-full p-0">
        <div className="absolute w-[204px] h-[62px] top-0 left-[18px]">
          <div className="relative w-[202px] h-[62px]">
            <div className="flex w-[202px] h-[41px] items-center justify-center gap-[23.89px] absolute top-0 left-0">
        ...
        <div className="absolute w-[215px] h-6 top-[67px] left-[18px]">
          <div className="flex w-[89px] items-center gap-[5.9px] absolute top-1.5 left-0">
            <div className="inline-flex items-center justify-center gap-[2.95px] relative flex-[0_0_auto]">
              <img
                className="w-[18.56px] mt-[-3771.61px] ml-[-1750.84px] relative h-[12.95px]"
                alt="Subtract"
                src="/subtract.svg"
              />
            ...
            <div className="inline-flex items-center justify-center gap-[3.81px] relative flex-[0_0_auto] mr-[-2.93px]">
              <img
                className="relative w-[12.39px] h-[11.83px] mt-[-3771.95px] ml-[-1809.25px]"
                alt="Vector"
                src="/vector-9.svg"
              />
          ...
          <div className="absolute top-[3px] left-40 [font-family:'Nunito',Helvetica] font-bold text-[#000000] text-[15.3px] tracking-[0] leading-[18.4px] whitespace-nowrap">
            70 AED
          </div>
          ...
          <div className="absolute w-[17px] h-[17px] top-1 left-[105px] overflow-hidden">
            <div className="relative w-[13px] h-[15px] top-[-3770px] left-[-1856px] bg-[url(/vector-14.svg)] bg-[100%_100%]">
              <img
                className="top-0 left-0 absolute w-2 h-2"
                alt="Element"
                src="/50mins.svg"
              />
            </div>
          ...
          <img
            className="absolute w-[13px] h-px top-[-3766px] left-[-1751px]"
            alt="Line"
            src="/line-3.svg"
          />
        </div>

        <div className="top-[50px] left-[281px] absolute w-[87px] h-9">
          <div className="relative w-9 h-9 top-[-3749px] left-[-2014px] bg-[100%_100%]">
            <img
              className="w-9 h-9 absolute top-0 left-0 object-cover"
              alt="Careem logo"
            />

            <img className="absolute w-9 h-9 top-0 left-0" alt="Noon logo" />
          </div>
        </div>
      </CardContent>
    </Card>
