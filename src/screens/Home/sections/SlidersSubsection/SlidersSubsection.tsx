  ...
  const restaurantCards = [
    {
      ...
      image: {
        src: "", // Image URL is missing in original code
        alt: "Coold sweet ice",
      },
    },
    {
              ...
              <Card className="w-full max-w-[389px] h-[137px] bg-white rounded-xl overflow-hidden border border-gray-300 shadow-lg mx-auto">
                <CardContent className="p-0 h-full relative">
                  <div className="absolute w-[232px] h-[164px] top-[-39px] left-[-21px]">
                    ...
                    <Button
                      className={`absolute top-[134px] left-[37px] ${card.buttonColor} rounded-[25.12px] h-auto px-[7.99px] py-[4.57px] [font-family:'Poppins',Helvetica] font-semibold text-white text-[13.7px]`}
                    >
                      ORDER NOW
                    </Button>
                  </div>
                  ...
                  {index === 0 && (
                    <div className="absolute w-[177px] h-[120px] top-2.5 left-[212px]">
                      <div className="absolute w-[103px] h-6 top-24 left-[23px] bg-[#00000080] rounded-[51.38px/11.99px] blur-[7.99px]" />
                      <img
